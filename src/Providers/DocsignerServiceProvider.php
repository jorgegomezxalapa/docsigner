...
namespace EdgarOrozco\Docsigner\Providers;

use EdgarOrozco\Docsigner\Docsigner;
use Illuminate\Support\ServiceProvider;

class DocsignerServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/docsigner.php' => config_path('docsigner.php'),
        // ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'docsigner');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'docsigner');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/docsigner'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'docsigner');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/docsigner'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \EdgarOrozco\Docsigner\Console\Commands\DocsignerCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/docsigner'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(
             __DIR__.'/../../config/docsigner.php', 'docsigner'
         );

        $this->app->bind('docsigner', function($app) {
            return new Docsigner();
        });
    }
}
